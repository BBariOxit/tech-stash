                ...
                >
                  <div className="relative flex-1">
                    ...
                    <Input
                      ...
                      required
                      className="pl-9 bg-white/[0.04] border-white/[0.08] text-white placeholder:text-zinc-400 focus-visible:border-primary/50 focus-visible:ring-primary/20 h-10"
                    />
                  </div>
                  <Button
                    type="submit"
                    disabled={state === "loading"}
                    className="bg-primary text-zinc-950 font-semibold hover:bg-primary/90 disabled:opacity-70 h-10 px-5 shrink-0 transition-colors"
                  >
                    {state === "loading" ? (
